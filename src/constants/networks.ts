...
export const NETWORKS_INFO: { [key in ChainId]: NETWORK_INFO } = {
  ...
  [ChainId.CRONOS]: {
    ...
    subgraphUrls: ['https://cronos-graph.kyberengineering.io/subgraphs/name/kybernetwork/kyberswap-exchange-cronos/graphql'],
    subgraphBlockUrl: 'https://cronos-graph.kyberengineering.io/subgraphs/name/kybernetwork/kyberswap-exchange-cronos/graphql',
